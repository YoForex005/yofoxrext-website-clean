...
- **Code Changes**: Modified `app/dashboard/page.tsx` to remove server-side auth check and updated `DashboardClient.tsx` to show login prompt when not authenticated
